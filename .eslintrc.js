module.exports = {
  ...
  rules: {
    ...
    "react/no-unknown-property": 0, // 不允许使用未知的 DOM 属性
    "react/prop-types": 0, // props 类型验证
    ...
    "react/jsx-indent-props": "off", // props 的缩进\
    ...
    "react/no-array-index-key": 0, //防止在数组中遍历中使用数组索引做key
